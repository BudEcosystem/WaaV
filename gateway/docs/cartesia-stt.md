...
WaaV Gateway supports Cartesia Speech-to-Text for real-time streaming speech recognition using WebSocket bidirectional streaming.
...
Cartesia STT responses are converted to WaaV Gateway's unified `STTResult` format:
