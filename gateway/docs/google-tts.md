...
WaaV Gateway supports Google Cloud Text-to-Speech API for high-quality speech synthesis using WaveNet, Neural2, and Studio voice technologies.
...
4. **Caching**: WaaV Gateway caches TTS audio based on configuration hash
