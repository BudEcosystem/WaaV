...
```bash
docker run -d -p 3001:3001 waav-gatewayai/waav-gateway
```
...
For complete documentation, visit [https://docs.waav-gateway.ai](https://docs.waav-gateway.ai)

## Source Code

[https://github.com/waav-gatewayai/waav-gateway](https://github.com/waav-gatewayai/waav-gateway)
