...
fn test_openai_in_supported_realtime_providers() {
    ...
    assert_eq!(providers.len(), 11); // OpenAI, Hume + Azure/Grok/Inworld clones + Deepgram VA + ElevenLabs ConvAI + Gemini Live + Ultravox + AWS Nova Sonic + Speechmatics Flow (S2S)
}
