...
pub use config::{
    ZaloTtsConfig, ZaloTtsData, ZaloTtsResponse, ZaloVoice, AUDIO_CHANNELS, AUDIO_SAMPLE_RATE,
    AUDIO_SAMPLE_WIDTH, DEFAULT_SPEED, MAX_SPEED, MIN_SPEED, ZALO_TTS_ENDPOINT,
};
