...
//!
//! ```rust,ignore
//! use waav_gateway::core::tts::cartesia::{CartesiaTTSConfig, CartesiaOutputFormat};
...
///
/// ```rust,ignore
/// use waav_gateway::core::tts::cartesia::CartesiaAudioContainer;
///
...
///
/// ```rust,ignore
/// use waav_gateway::core::tts::cartesia::CartesiaAudioEncoding;
///
...
pub enum CartesiaAudioEncoding {
    ...
    /// Matches WaaV Gateway's "linear16" format for seamless integration.
    #[default]
...
impl CartesiaOutputFormat {
    ...
    ///
    /// ```rust,ignore
    /// use waav_gateway::core::tts::cartesia::{CartesiaOutputFormat, CartesiaAudioEncoding};
    ///
    ...
    ///
    /// ```rust,ignore
    /// use waav_gateway::core::tts::cartesia::CartesiaOutputFormat;
    ///
    ...
    /// Maps WaaV Gateway's base config format strings to Cartesia output format.
    ///
    /// # Arguments
    ///
    ...
    ///
    /// ```rust,ignore
    /// use waav_gateway::core::tts::cartesia::{CartesiaOutputFormat, CartesiaAudioContainer};
    ///
...
impl CartesiaTTSConfig {
    ...
    ///
    /// ```rust,ignore
    /// use waav_gateway::core::tts::{TTSConfig, cartesia::CartesiaTTSConfig};
    ///
    /// let base = TTSConfig {
    ...
    ///
    /// ```rust,ignore
    /// use waav_gateway::core::tts::cartesia::CartesiaTTSConfig;
    ///
