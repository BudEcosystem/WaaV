...
pub use config::{
    ViettelTtsConfig, ViettelTtsResponse, ViettelVoice, AUDIO_SAMPLE_RATE, DEFAULT_SPEED,
    DEFAULT_TTS_RETURN_OPTION, MAX_SPEED, MAX_TEXT_LENGTH, MIN_SPEED, MIN_TEXT_LENGTH,
