...
//!
//! ```rust,no_run
//! use waav_gateway::core::providers::google::{CredentialSource, GoogleAuthClient, TokenProvider};
//!
//! #[tokio::main]
...
impl GoogleAuthClient {
    ...
    ///
    /// ```rust,no_run
    /// use waav_gateway::core::providers::google::{CredentialSource, GoogleAuthClient};
    ///
