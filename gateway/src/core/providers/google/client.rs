...
//! ```rust,no_run
//! use std::sync::Arc;
//! use waav_gateway::core::providers::google::{
...
///
/// ```rust,no_run
/// use waav_gateway::core::providers::google::create_grpc_channel;
///
/// async fn example() -> Result<(), Box<dyn std::error::Error>> {
///     let channel = create_grpc_channel("https://speech.googleapis.com").await?;
...
impl AuthenticatedChannel {
    ...
    ///
    /// ```rust,no_run
    /// use waav_gateway::core::providers::google::AuthenticatedChannel;
    ///
