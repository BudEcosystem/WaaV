...
//!
//! ```rust
//! use waav_gateway::core::providers::azure::{AZURE_SUBSCRIPTION_KEY_HEADER, build_subscription_key_header};
//!
...
///
/// ```rust
/// use waav_gateway::core::providers::azure::AZURE_SUBSCRIPTION_KEY_HEADER;
///
...
///
/// ```rust
/// use waav_gateway::core::providers::azure::AZURE_AUTHORIZATION_HEADER;
///
...
///
/// ```rust
/// use waav_gateway::core::providers::azure::build_subscription_key_header;
///
/// let api_key = "your-subscription-key";
...
///
/// ```rust
/// use waav_gateway::core::providers::azure::build_bearer_token_header;
///
...
///
/// ```rust
/// use waav_gateway::core::providers::azure::{AzureRegion, build_token_request_url};
///
